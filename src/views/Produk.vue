<template>
    ...
    <div v-else>
    <div class="grid md:grid-cols-4 gap-8  mt-10 pl-5">
        <div  v-for="product in getProduk.slice(0,12)" :key="product.slug">
  
        <div class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-gray shadow-md">
            <a href="#">
                <img class="h-50 rounded-t-lg object-cover w-full" 
            ...
            <div class="mt-4 px-5 pb-5">
                ...
                <div>
                    <router-link :to="{ name: 'SingleProduk', params: { slug: product.slug } }" class="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 mt-5">
