                    ...
                    <div class="lg:col-span-3">
                        <div class="border-b border-gray-300">
                            <nav class="flex gap-4">
                                <a href="#" title=""
                                    class="border-b-2 border-gray-900 py-4 text-sm font-medium text-gray-900 hover:border-gray-400 hover:text-gray-800"> Description </a>
                            </nav>
                        </div>
                        <p>AHA BHA merupakan dua jenis active ingredients yang biasanya tersedia dalam bentuk toner yang memiliki manfaat dalam mengangkat sel-sel kulit mati. Kedua kandungan ini hanya bekerja pada lapisan terluar atau pada permukaan kulit dan biasanya berfungsi sebagai chemical exfoliant.</p>
